...
function realMetadata(tokenId, req) {
  ...
  return {
    ...
    description:
      ...
      `Rarity: ${m.rarity}. Part of a 6,000-piece mining rig collection. ` +
...
function placeholderMetadata(tokenId, req) {
  return {
    ...
    description: "This NFT reveals automatically as soon as its mint is confirmed on Robinhood Chain.",
...
module.exports = {
  CONTRACT, CHAIN_ID, MAX_SUPPLY, MAPPING_SHA256,
